...
決して関係者とか回し者とかではないのですが、アイスブレイク的にほんの少しだけ紹介させてください。

狼と香辛料は、2008年にアニメ化されて、現在は2期まで放送済みなのですが、今回、2期の続きからと思いきや、なんと一番最初から完全新作としてアニメ化されるそうです。
エンジニア界隈でいうところの、いわゆる「リニューアル」というやつですね。
